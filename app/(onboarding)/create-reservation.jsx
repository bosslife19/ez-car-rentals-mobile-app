...
export default function CreateReservation() {
  return (
    <View style={styles.container}>
      <ImageBackground
        source={require('@/assets/images/onboarding-car.png')} // Replace with your image URL or local image path
        style={styles.image}
        resizeMode='cover'
      >
        <LinearGradient
...
>
  Rent Cars for your Convenience
</Text>
...
>
  Book a car near you instantly. Save time by verifying your ID online
  through the latest technology that our app employs.
</Text>

<View style={{flexDirection:'row', gap:4, margin:8}}> 
  <View style={{width:17, height:17, borderRadius:8.5,backgroundColor:'#00A1EA'}}></View>
  <TouchableOpacity style={{width:14, height:14, borderRadius:8.5,backgroundColor:'#E0DEDE'}} onPress={()=>router.push('/third-onboarding')}></TouchableOpacity>
</View>
<TouchableOpacity onPress={()=>router.push('/third-onboarding')}>
